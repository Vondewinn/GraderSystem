...
public class TitlePopup extends PopupWindow {
	...
	public TitlePopup(Context context, int width, int height){
		...
		//获得屏幕的宽度和高度
		mScreenWidth = PopupUtils.getScreenWidth(mContext);
		mScreenHeight = PopupUtils.getScreenHeight(mContext);
	...
	public void show(View view){
		...
		//显示弹窗的位置
//		showAtLocation(view, Gravity.HORIZONTAL_GRAVITY_MASK, mScreenWidth - LIST_PADDING - (getWidth()/2), mRect.bottom);
		//showAtLocation(view, Gravity.RIGHT, 500, 500);
		showAsDropDown(view, 80, -180);
