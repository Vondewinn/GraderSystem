...
public class DataUtils {
    ...
    public static String dataStitching(String header, String dataPart) {
        int headerLength = header.length();
        strData = strData + dataPart;
        int s = strData.indexOf(header);
        String subData = strData.substring(s + headerLength);

        if (subData.contains(header)) {
            String outData = strData.substring(s, subData.indexOf(header) + headerLength);
            strData = subData.substring(subData.indexOf(header));
            return outData;
        } else {
            return null;
        }
