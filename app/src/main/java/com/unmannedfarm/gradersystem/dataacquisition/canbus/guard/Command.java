package com.unmannedfarm.gradersystem.dataacquisition.canbus.guard;
...
public class Command {
    ...
    public static class Send {
        ...
        public static byte[] filterCan(byte[] id) {
            byte[] protocolData = new byte[id.length + 3];//Э���������� 1 + ��ǰ���� 2 + ���ݳ���
            protocolData[0] = 0x50;
        ...
        public static List<String> GpioName() {
            ...
            list.add("RADAR_IN(GPIO) �߽���12V��Դ��ѹ");
            list.add("MCU_PWM2(GPIO) �߽�����ߣ�GND��");
            list.add("MCU_PWM1(GPIO) �߽�����ߣ�GND��");
            list.add("MCUIN1(GPIO) �߽���12V��Դ��ѹ");
            list.add("MCUIN2(GPIO) �߽���12V��Դ��ѹ");
            list.add("Mileage_pwr_en(GPIO)");
            list.add("Mileage_mcuin(GPIO) �߽���12V��Դ��ѹ");
            return list;
        }
        ...
        public static byte[] sendData(byte[] data, byte type) {
            byte[] protocolData = new byte[data.length + 3];//Э���������� 1 + ��ǰ���� 2 + ���ݳ���
            protocolData[0] = type;
