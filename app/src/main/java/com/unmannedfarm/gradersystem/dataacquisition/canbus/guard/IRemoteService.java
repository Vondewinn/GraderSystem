 ...
 * Original file: E:\\java_code\\elm\\e9631service\\src\\main\\aidl\\com\\android\\guard\\IRemoteService.aidl
 */
...
@Override
public void registerCallback(IRemoteServiceCallBack cb) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override
public void unregisterCallback(IRemoteServiceCallBack cb) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
