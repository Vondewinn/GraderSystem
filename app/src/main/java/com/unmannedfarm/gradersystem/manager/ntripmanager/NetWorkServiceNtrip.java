...
public class NetWorkServiceNtrip {
    ...
    //构造函数
    public NetWorkServiceNtrip(Context context, String ipAdress, String port
            , String userID, String password, String mountedpoint) {
        ...
        public void run() {
            ...
            try {
                ...
                if(NetWorkServiceNtrip.this.dos != null){
                    ...
                    NetWorkServiceNtrip.this.dos.write(UtilNtrip.CreateHttpRequsets(NetWorkServiceNtrip.this.mMountedpoint
...
//                                System.out.println("GGA:" + UtilNtrip.byte2HexStr(this.buffer));
                                GpsDifferentialData gpsDifferentialData = new GpsDifferentialData();
                                gpsDifferentialData.setGpsDiffData(this.buffer);
                                EventBus.getDefault().post(gpsDifferentialData);
                            }
                        }
                    }
                }
